  ...
  <section id="chat">
    ...
    <div id="feed">
      ...
      <pre style="font-size:15px">
        - Lista de fala;
        - Feed da organização;
        - Chat com mensagens interativas;
      </pre>
      <hr>
    ...
    <div class="painel">
      <div class="box1">
        ...
        <div class="comment-box">
          <input id="msgContent" type="text" placeholder="Insira sua mensagem aqui" v-model="inputMessage">
      ...
      <div id="painel-ficha">
        <section id="ficha">
          ...
          <div id="painel-nomes">
            <div id="botao-clock">
              <button id="startCountDown" @click="cronometrar()">
                <i class="fa fa-clock-o" aria-hidden="true"></i>
              </button>
              <br>
            </div>
            <div id="boxSub" v-for="user in listaFala" :key="user.nome">
              <div><strong>{{user.nome}}</strong> - {{user.tempo}}s</div>
            </div>
          </div>
          <div id="input-box">
